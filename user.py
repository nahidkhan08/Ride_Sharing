...
from ride import RideRequest, RideMatching, Ride, RideSharing
class User(ABC):
...
class Rider(User):
    ...
    def load_cash(self, amount):
        if amount>0:
            self.wallet+=amount
            print("Amount {amount} is added to wallet.")
        else:
    ...
    def show_current_ride(self):
        ...
        print(f'Selected Car: {self.current_ride.vehicle_type}')
